...
const FrameComponent5: NextPage = () => {
  ...
  return (
    <section className="text-13xl font-inter box-border flex w-[1391px] max-w-full flex-row items-start justify-center px-0 pb-[62px] pt-0 text-center text-white">
      <div className="mq750:gap-[17px_68.5px] flex w-[1195px] max-w-full flex-col items-end justify-start gap-[68.5px] lg:gap-[34px_68.5px]">
        <div className="flex max-w-full flex-row flex-wrap items-start justify-start gap-[29px] self-stretch">
          <div className="box-border flex w-[38px] flex-col items-start justify-start py-0 pl-0 pr-[23px]">
            <div className="mq450:text-lgi mq450:leading-[14px] mq1050:text-7xl mq1050:leading-[18px] relative self-stretch leading-[23px]">
              1
            </div>
          </div>
        ...
        <div className="box-border flex max-w-full flex-row items-start justify-end self-stretch py-0 pl-0 pr-[39px] text-9xl">
          <div className="mq750:gap-[19px] flex max-w-full flex-1 flex-row flex-wrap items-start justify-start gap-[39px]">
            <div className="box-border flex w-[204px] flex-col items-start justify-start px-0 pb-0 pt-0.5">
            ...
            <div className="rounded-3xs text-darkslategray border-darkslategray mq450:gap-[34.8px_17px] mq1050:flex-wrap mq1050:min-w-full z-[1] box-border flex min-w-[593px] max-w-full flex-1 flex-row items-end justify-start gap-[34.8px] border-[1px] border-solid px-[33px] pb-[26px] pt-[23px]">
              <div className="box-border flex w-[294.2px] flex-col items-start justify-end px-0 pb-[3.3px] pt-0">
                ...
                >
                  <div className="mq450:text-3xl mq450:leading-[18px] absolute left-[calc(50%_-_147.1px)] top-[0px] flex h-full w-[282.6px] items-center justify-center leading-[22.53px]">
                    Add more options
                  </div>
