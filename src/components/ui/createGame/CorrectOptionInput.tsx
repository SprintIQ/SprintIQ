...
const CorrectOptionInput: React.FC<{
  ...
  return (
    <div className="mr-auto w-fit lg:mr-0">
      <button
        onClick={onClick}
        className="lg:max-w-auto mr-auto w-fit max-w-[300px] overflow-hidden text-ellipsis whitespace-nowrap bg-transparent text-xl leading-[22.53px] text-secondary-700 outline-none hover:text-[#1FC04D]"
      >
