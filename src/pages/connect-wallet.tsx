...
const ConnectWallet: NextPage = () => {
  ...
  return (
    <div className="text-45xl font-inter mq1550:pl-5 mq1550:pr-5 mq1550:box-border relative box-border flex w-full flex-row items-start justify-between gap-[20px] overflow-hidden py-0 pl-[174px] pr-0 text-center tracking-[normal]  [background:linear-gradient(180deg,_#0e2615,_#0f0f0f)]">
